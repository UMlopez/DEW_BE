...
namespace DBContext
{
  public class UserRepository : BaseRepository, IUserRepository
  {
    ...
    public ResponseBase ValidarDatosCambioContraseña(EntityUser user)
    {
      var returnEntity = new ResponseBase();
      ...
      try
      {
        using (var db = GetSqlConnection())
        {
          const string sql = @"usp_ValidarDatosCambioContraseña";
    ...
    public ResponseBase CambiarContraseña(EntityUser user)
    {
      var returnEntity = new ResponseBase();
      ...
      try
      {
        using (var db = GetSqlConnection())
        {
          const string sql = @"usp_CambiarContraseña";
          ...
          else
          {
            returnEntity.isSuccess = false;
            returnEntity.errorCode = "0001";
            returnEntity.errorMessage = "La contraseña no pudo ser modificada";
            returnEntity.data = null;
          }
        }
      }
